...
version = "new_features_v7_tuning_v8"
...
def objective(trial):
    params = {
        **static_params,
        ...
        "lambda_l2": trial.suggest_float("lambda_l2", 2, 10.0, log=True),
        "learning_rate": trial.suggest_float("learning_rate", 0.001, 0.1, log=True),
        "num_leaves": trial.suggest_int("num_leaves", 10, 512),
        "feature_fraction": trial.suggest_float("feature_fraction", 0.2, 1.0),
        "bagging_fraction": trial.suggest_float("bagging_fraction", 0.2, 1.0),
        "max_depth": trial.suggest_int("max_depth", 5, 30),  # MAXIMUM 15, now the best was 10
        # "min_child_samples": trial.suggest_int("min_child_samples", 5, 100),
        # "early_stopping_rounds": trial.suggest_int("early_stopping_rounds", 50, 200),
    }

    prune_callback = optuna.integration.LightGBMPruningCallback(trial, "auc")
